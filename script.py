...
def send_on_call_alert():
    ...
    message = f"🚨 *Weekly Monitoring Owner Alert!* 🚨\nThis week's owner of UBS backend alerts: {on_call['slack_id']}. Please monitor all #gsp-brands-alerts and #gsp-brands-alerts-stage messages and create bug reports or escalations to the team, as needed."
